        ...
        >
          ...
          {!signIn && (
            <input
              ref={name}
              type="name"
              className=" py-3 bg-black text-white px-3 border border-slate-500 rounded-md focus:bg-slate-600 hover:cursor-pointer focus:text-black"
              placeholder="Name"
            />
          )}
          <input
          ...
          />
          {messages && (
            <span className="font-bold text-red-600 text-sm">{messages}</span>
          )}
          <button
            onClick={handleclick}
            className="bg-red-600 rounded-md py-2 mt-5 mb-1"
          >
            {signIn ? "Sign In" : "Sign Up"}
          </button>
          <span className="cursor-pointer" onClick={toggleSignIn}>
            {signIn ? "New to Netflix? Sign Up." : "Already an user? Sign In"}
          </span>
        </form>
      </div>
    </div>
